...
let altNoWarning = undefined
let scrollEffect = "wait 0.1s, ease-out 100px"
	...
	return (
		<>
			<div className="parent">
				...
				<a href="https://python.plainenglish.io/top-10-programming-languages-to-learn-in-2022-ff98fb5170fc" target="_blank"
					rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						Top 10 Programming Languages to Learn in 2022

						<img src="https://miro.medium.com/max/2000/1*IqI3S9tAe-rv9rzq5CXCDQ.png"
							loading="lazy" alt={ altNoWarning } />
					</div>
				</a>
				...
				<a href="https://opensource.com/article/21/12/open-source-security" target="_blank"
					rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						5 open source security resources from 2021

						<img src="https://opensource.com/sites/default/files/styles/image-full-size/public/lead-images/rh_003601_05_mech_osyearbook2016_security_cc.png?itok=3V07Lpko"
							loading="lazy" alt={ altNoWarning } />
					</div>
				</a>
				...
				<a href="https://dev.to/thatanjan/13-reasons-why-you-should-use-nextjs-2d40" target="_blank" rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						...
						<img src="https://res.cloudinary.com/practicaldev/image/fetch/s--0pmRbIcs--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/4hjvap8num2ngjp2xdpy.png" loading="lazy" alt={ altNoWarning } />
					</div>
				</a>
				...
				<a href="https://blog.devgenius.io/node-js-in-go-we-trust-7da6395776f2" target="_blank"
					rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						Node.js: In Go We Trust

						<img src="https://miro.medium.com/max/1400/1*L3Ji1R9lHKUaiDlGW-Rlww.png" loading="lazy" alt={ altNoWarning } />
					</div>
				</a>

				<a href="https://www.freecodecamp.org/news/23-free-websites-to-learn-javascript/" target="_blank" rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						23 Free Websites to Learn JavaScript in 2022

						<img src="https://www.freecodecamp.org/news/content/images/size/w600/2021/12/Learn--1-.png" loading="lazy" alt={ altNoWarning } />
					</div>
				</a>
				...
				<a href="https://www.freecodecamp.org/news/how-to-use-commitlint-to-write-good-commit-messages/" target="_blank"
					...
					<div className="preview" data-sr={ scrollEffect }>
						...
						<img src="https://www.freecodecamp.org/news/content/images/size/w2000/2021/11/Thumbnail.png" loading="lazy" alt={ altNoWarning } />
					</div>
				</a>

				<a href="https://web.dev/state-of-css-2021/"
					target="_blank" rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						State of CSS 2021

						<img src="https://web-dev.imgix.net/image/kheDArv5csY6rvQUJDbWRscckLr1/wq71mnWZKXuruohdemDU.png?auto=format&w=741" loading="lazy" alt={ altNoWarning } />
					</div>
				</a>

				<a href="https://javascript.plainenglish.io/programming-languages-to-learn-in-2022-for-job-future-3f72aa48fc02" target="_blank"
					rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						Programming Languages to Learn in 2022 (for Job & Future)

						<img src="https://miro.medium.com/max/1400/1*zfu91KkkryN-D7sMd8cWfA.jpeg"
							loading="lazy" alt={ altNoWarning } />
					</div>
				</a>

				<a href="https://faun.pub/best-practices-for-better-restful-api-a54b4e374cab"
					target="_blank" rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						Best Practices for Better RESTful API

						<img src="https://miro.medium.com/max/1400/1*lWi9I7Qzrlsi9cG5IMD07A.png"
							loading="lazy" alt={ altNoWarning } />
					</div>
				</a>
				...
				<a href="https://dzone.com/articles/22-software-development-trends-for-2022-1" target="_blank" rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						...
						<img src="https://dz2cdn1.dzone.com/storage/temp/15428582-blog-trends-2022-3.png" loading="lazy" alt={ altNoWarning } />
					</div>
				</a>
				...
				<a href="https://dev.to/muthuannamalai12/7-awesome-ways-to-screenshot-your-code-4h15" target="_blank"
					...
					<div className="preview" data-sr={ scrollEffect }>
						...
						<img src="https://res.cloudinary.com/practicaldev/image/fetch/s--pD0E15X0--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/m4hhpefnyf83o6qsk194.png" loading="lazy" alt={ altNoWarning } />
					</div>
				</a>
				...
				<a href="https://blog.openreplay.com/react-architecture-patterns-for-your-projects"
					target="_blank" rel="noopener noreferrer">
					<div className="preview" data-sr={ scrollEffect }>
						React Architecture Patterns for Your Projects

						<img src="https://blog.openreplay.com/static/0bb66cc399c054aa8d27f9bdbf9866fa/99fbb/hero.webp"
							loading="lazy" alt={ altNoWarning } />
					</div>
				</a>
			...
			<footer>
				Made by <a href="https://github.com/martinval9/" target="_blank" rel="noopener noreferrer" id="martinval9-github">martinval9</a>
			</footer>
		</>
	)
}
